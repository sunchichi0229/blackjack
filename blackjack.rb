...
class Blackjack
    ...
    def judge(player, dealer, money)
        ...
        @player_point = player.point_player
        puts <<~text
        プレイヤーの手札の合計点数は#{@player_point}です。
        --------------------------------------------
        text
        ...
        #ディーラーの点数がプレイヤーの点数より高い(ディーラーの勝利)
        ...
        #ディーラーの点数がプレイヤーの点数より低い(プレイヤーの勝利)
        else 
